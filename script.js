...
function getAiReply(message) {
  ...
  if (text.includes('ipad air')) {
    return 'The iPad Air M2 is available too. It is a strong option if you want good performance at a better balance in price.';
  }
  if (text.includes('ipad') || text.includes('tablet')) {
    return 'We have tablets like iPad Pro M4, iPad Air M2, and Lenovo Legion Y700. I can help you choose the best one for gaming.';
  }
  ...
  if (text.includes('thumb') || text.includes('sleeves')) {
    return 'Thumb sleeves are available and they help improve touch control while gaming.';
  }
  if (
  ...
  if (text.includes('price') || text.includes('cost') || text.includes('how much')) {
    return 'The prices are shown in the product section. If you mention a product name, I can tell you about that item directly.';
  }
  if (text.includes('cart')) {
    return 'When you tap Add to Cart, the item should appear inside the cart section and the total will update automatically.';
  }
  ...
  if (text.includes('hello') || text.includes('hi')) {
    return 'Hi, welcome to KAWREX. I can help you with products, prices, payment, delivery, and recommendations.';
  }
  return 'I can help with gaming tablets, phones, headsets, thumb sleeves, prices, cart, payment, and delivery. For other gadgets and gaming devices, please message us on WhatsApp: +234-8069564602.';
}
...
if (proceedBtn) {
  proceedBtn.addEventListener('click', function () {
    ...
    proceedMessage.textContent = 'Proceed with payment using the bank details above, then send your proof of payment on WhatsApp.';
  });
}
